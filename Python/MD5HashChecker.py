...
referenceFile = input("Please enter reference copy filepath:")
CheckFile = input("Please enter the file to be checked filepath:")

with open(referenceFile, 'rb') as file1:#enter file name and extension to read the file, file is read as binary for MD5 to work
    file1hash = file1.read()
    hashcryp.update(file1hash)
hash1 = hashcryp.hexdigest()
print(hashcryp.hexdigest())

with open(CheckFile, 'rb') as file2:#enter file name and extension to read the file, file is read as binary for MD5 to work
